...
namespace parse {
	 ...
	 */
	void readWindow(std::string file, unsigned int &width, unsigned int &height, sf::Color& BgColor, int& aliensPerRow,int& nrRows , int& nrAlien1 , int& nrAlien2 ,int& nrAlien3, int& nrBunkers );
}
